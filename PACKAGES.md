...
- [**@maitask/pdf-parser**](./pdf-parser) `v0.1.0` — Extract Info metadata and uncompressed PDF text operators
...
- [**@maitask/stream-publisher**](./stream-publisher) `v0.1.0` — Publish NDJSON or SSE event streams to an HTTPS endpoint
...
- [**@maitask/graphql-client**](./graphql-client) `v0.1.0` — Execute GraphQL queries and mutations over HTTPS with secret-backed bearer tokens

## Export & Storage (3)

- [**@maitask/excel-exporter**](./excel-exporter) `v0.1.0` — Convert tabular data to CSV for download or downstream adapters
- [**@maitask/nocodb-importer**](./nocodb-importer) `v0.1.0` — Import data to NocoDB with authentication
- [**@maitask/s3-storage**](./s3-storage) `v0.1.0` — Upload, download, or delete objects through presigned S3 URLs
